...
private:
    ...
    double bias_, maxSegmentLength_;
    ...
    int findNearestNode(const Eigen::Vector2d &point)
    {
        int nearestIndex = -1;
    ...
    bool isValid(const Eigen::Vector2d &point)
    {
...
public:
    RRT(const Eigen::Vector2d &start, const Eigen::Vector2d &goal, double bias, double maxSegmentLength)
